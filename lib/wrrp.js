...
class WeightedRoundRobin {
  ...
  getRoundRobin (item, options) {
    let { reverse, max, min, filter } = Object.assign({}, this._options, options)
  ...
  _filter (peerMapLength, filterOptions) {
    const { enable, number, totalWeight, ratio } = Object.assign({}, this._options.filter, filterOptions)
